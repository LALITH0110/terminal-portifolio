...
- **Conversational AI**: Shadow can answer questions about Lalith, the portfolio, and general topics (with restrictions).
- **Persona**: Shadow introduces itself and responds as your digital guide.
- **Knowledge Base Restriction**: For questions about Lalith, Shadow only uses information from a curated knowledge base (`src/lib/knowledge.json`).
...
| `about`    | Learn about Lalith and his goals          |
...
**Lalith** is a passionate BCA student from India, specializing in:
